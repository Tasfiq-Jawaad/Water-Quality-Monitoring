/****************************************************************************
** Meta object code from reading C++ file 'CardWidget.hpp'
**
...
#error "The header file 'CardWidget.hpp' doesn't include <QObject>."
...
void CardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &CardWidget::cardClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
